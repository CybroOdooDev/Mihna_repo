...
#############################################################################
{
    ...
    * Tracks the submission status (To Send / Submitted / Acknowledged / Rejected / Error) and polls
    ...
    NOTE: this module targets the ASP integration only, independent of the generic multi-ASP
    'l10n_om_edi' module - it does not depend on it and can be installed on its own, the same way
    'l10n_om_convergex' works for the ConvergeX ASP.
    """,
