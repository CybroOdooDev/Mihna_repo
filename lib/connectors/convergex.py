...
@register_connector('convergex')
class ConvergeXConnector(L10nOmEdiConnector):
    """ Stub connector for ConvergeX.

    CONFIRMED OTA-ACCREDITED: listed on the Oman Tax Authority's official accredited-provider list
    (checked 2026-07-30, full list of 12): legal entity "Artificial Intelligence Business Solutions",
    Solution Name "ConvergeX", Data Residency Oman, contact mrishad@aibizs.com -
    ...
    CONFIG_NOTES = ("Officially OTA-accredited for Oman (Data Residency: Oman; contact "
                     "mrishad@aibizs.com). No public API/authentication documentation has been located "
