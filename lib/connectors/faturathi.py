...
@register_connector('faturathi')
class FaturathiConnector(L10nOmEdiConnector):
    """ Stub connector for Faturathi.

    CONFIRMED OTA-ACCREDITED: listed on the Oman Tax Authority's official accredited-provider list
    (checked 2026-07-30, full list of 12): legal entity "International Intelligence Solutions LLC",
    Solution Name "Faturathi", Data Residency Oman, contact prajith@netbue.com -
    ...
    CONFIG_NOTES = ("Officially OTA-accredited for Oman (Data Residency: Oman; contact "
                     "prajith@netbue.com). No public API/authentication documentation has been located "
