...
@register_connector('goroute')
class GoRouteConnector(L10nOmEdiConnector):
    """ Stub connector for GoRoute.

    CONFIRMED OTA-ACCREDITED: listed on the Oman Tax Authority's official accredited-provider list
    (checked 2026-07-30, full list of 12): legal entity "Union Digital Technologies", Solution Name
    "GoRoute", Data Residency Oman, contact info@uniondigitaltechnologies.com -
    ...
    CONFIG_NOTES = ("Officially OTA-accredited for Oman (Data Residency: Oman; contact "
                     "info@uniondigitaltechnologies.com). No public API/authentication documentation "
                     "has been located yet - contact them directly to request developer docs/sandbox "
                     "access.")
