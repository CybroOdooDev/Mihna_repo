...
@register_connector('smarteis')
class SmarteisConnector(L10nOmEdiConnector):
    """ Stub connector for SMARTeIS.

    CONFIRMED OTA-ACCREDITED: listed on the Oman Tax Authority's official accredited-provider list
    (checked 2026-07-30, full list of 12): legal entity "Al Ghazali Management and Economic
    Consultants" (a Crowe network member, per the contact domain), Solution Name "SMARTeIS", Data
    Residency Oman, contact aastha.rangan@crowe.om -
    ...
    CONFIG_NOTES = ("Officially OTA-accredited for Oman (Data Residency: Oman; contact "
                     "aastha.rangan@crowe.om). No public API/authentication documentation has been "
