...
@register_connector('webtel')
class WebtelConnector(L10nOmEdiConnector):
    """ Stub connector for Webtel.

    CONFIRMED OTA-ACCREDITED: listed on the Oman Tax Authority's official accredited-provider list
    (checked 2026-07-30, full list of 12): legal entity "Indus Novateur LLC", Solution Name "Webtel",
    Data Residency Oman, contact rajis@indusnovateur.com -
    ...
    CONFIG_NOTES = ("Officially OTA-accredited for Oman (Data Residency: Oman; contact "
                     "rajis@indusnovateur.com). No public API/authentication documentation has been "
