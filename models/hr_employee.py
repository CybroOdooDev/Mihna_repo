...
class HrEmployee(models.Model):
    ...
    @api.depends('insurance_ids', 'insurance_ids.amount', 'insurance_ids.state', 'insurance_percentage', 'insurance_ids.policy_coverage', 'insurance_ids.date_from', 'insurance_ids.date_to')
