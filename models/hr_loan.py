...
class HrLoanAcc(models.Model):
    ...
    def action_approve(self):
        ...
        loan_approve = self.env['ir.config_parameter'].sudo().get_bool('ohrms_loan_accounting.loan_approve')
        ...
        loan_approval_threshold = self.env['ir.config_parameter'].sudo().get_float('ohrms_loan_accounting.loan_approval_threshold', default=0.0)
