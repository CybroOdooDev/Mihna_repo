...
class HrPayslip(models.Model):
    ...
    def _get_payslip_lines(self, contract_ids, payslip_id):
        ...
        if payslip.leave_salary:
            ...
            default_leave_salary = (
                self.env['ir.config_parameter'].sudo().get_str('hr_vacation_mngmt.default_leave_salary')
                or self.env['ir.config_parameter'].sudo().get_str('default_leave_salary')
            )
