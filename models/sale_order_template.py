...
class SaleOrderTemplate(models.Model):
    ...
    plan_id = fields.Many2one('subscription.plan',
                              string='Recurring Plan',
                              help="Select the default recurring billing plan for orders created with this template.")
    is_forever = fields.Boolean(string='Last Forever',
                                default=True,
                                help="If checked, this subscription has no pre-defined end date.")
