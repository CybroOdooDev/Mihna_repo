...
class SubscriptionCloseReason(models.Model):
    ...
    retention_message = fields.Text(string='Message',
                                    help="This message will be displayed to convince the customer to stay"
                                         " (e.g., We don't want you to leave,"
                                         " can we offer to schedule a meeting with your account manager?)")
